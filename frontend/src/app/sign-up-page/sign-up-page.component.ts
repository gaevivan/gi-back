...
export class SignUpPageComponent {
  ...
  public readonly verifiedPasswordControl: FormControl = new FormControl('', [Validators.minLength(6), Validators.required, this.samePass.bind(this)]);
  ...
  private samePass(control: AbstractControl): ValidationErrors | null {
    ...
    return verifiedPassword === password ? null : {wrongVerificationPassword: true};
  }
